...
No separate Android WebView/WebKit or Reown Android kit is installed—the PWA runs on the browser engine already on your device, so just keep Chrome or Firefox up to date.
